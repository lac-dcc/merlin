...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    struct fru_common_header *header = (struct fru_common_header *)malloc(
        _len_header0 * sizeof(struct fru_common_header));
