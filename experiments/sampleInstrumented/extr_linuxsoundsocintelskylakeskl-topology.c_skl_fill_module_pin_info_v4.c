...
/* Type definitions */
struct TYPE_2__ {
  int /*<<< orphan*/ instance_id;
  int /*<<< orphan*/ module_id;
};
struct skl_module_pin {
  int in_use;
  int is_dynamic;
  int /*<<< orphan*/ pin_state;
  TYPE_1__ id;
};
...
skl_fill_module_pin_info_v4(struct skl_dfw_v4_module_pin *dfw_pin,
  ...
  for (i = 0; i < max_pin; i++) {
    counterskl_fill_module_pin_info_v40++;
