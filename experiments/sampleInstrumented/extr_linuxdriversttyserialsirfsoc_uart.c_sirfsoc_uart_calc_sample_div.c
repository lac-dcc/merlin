...
sirfsoc_uart_calc_sample_div(unsigned long baud_rate, unsigned long ioclk_rate,
  ...
  unsigned countersirfsoc_uart_calc_sample_div0 = 0;
...
int main(int argc, char *argv[]) {
  ...
  case 3: {
    unsigned long baud_rate = 150;

    unsigned long ioclk_rate = 150;

    int _len_set_baud0 = 22500;
    unsigned long *set_baud =
        (unsigned long *)malloc(_len_set_baud0 * sizeof(unsigned long));
    for (int _i0 = 0; _i0 < _len_set_baud0; _i0++) {
      set_baud[_i0] = ((-2 * (next_i() % 2)) + 1) * next_i();
  ...
  case 4: {
    unsigned long baud_rate = 200;

    unsigned long ioclk_rate = 200;

    int _len_set_baud0 = 40000;
    unsigned long *set_baud =
        (unsigned long *)malloc(_len_set_baud0 * sizeof(unsigned long));
    for (int _i0 = 0; _i0 < _len_set_baud0; _i0++) {
      set_baud[_i0] = ((-2 * (next_i() % 2)) + 1) * next_i();
