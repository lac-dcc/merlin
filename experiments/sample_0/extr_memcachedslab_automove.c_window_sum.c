...
window_sum(struct window_data *wd, struct window_data *w, uint32_t size) {
  unsigned counterwindow_sum0 = 0;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    struct window_data *wd =
        (struct window_data *)malloc(_len_wd0 * sizeof(struct window_data));
    ...
    struct window_data *w =
        (struct window_data *)malloc(_len_w0 * sizeof(struct window_data));
