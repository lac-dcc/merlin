...
void make_cube_faces(float *data, float ao[6][4], float light[6][4], int left,
  ...
  unsigned countermake_cube_faces1 = 0;
  unsigned countermake_cube_faces0 = 0;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    make_cube_faces(data, ao, light, left, right, top, bottom, front, back,
                    wleft, wright, wtop, wbottom, wfront, wback, x, y, z, n);
    free(data);
