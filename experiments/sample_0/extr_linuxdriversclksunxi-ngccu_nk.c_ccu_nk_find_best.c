...
ccu_nk_find_best(unsigned long parent, unsigned long rate, struct _ccu_nk *nk) {
  unsigned counterccu_nk_find_best1 = 0;
  unsigned counterccu_nk_find_best0 = 0;

  struct _ccu_nk *tempnk = nk;
  ...
  for (_k = nk->min_k; _k <= nk->max_k; _k++) {
    counterccu_nk_find_best0++;
    for (_n = nk->min_n; _n <= nk->max_n; _n++) {
      counterccu_nk_find_best1++;
  ...
  printf("at line 70 :");
  printf(" nk\n");
  printf(" %d\n", *tempnk, counterccu_nk_find_best1);
  printf(" %d\n", *tempnk, counterccu_nk_find_best0);
}
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int _len_nk0 = 1;
    struct _ccu_nk *nk =
        (struct _ccu_nk *)malloc(_len_nk0 * sizeof(struct _ccu_nk));
