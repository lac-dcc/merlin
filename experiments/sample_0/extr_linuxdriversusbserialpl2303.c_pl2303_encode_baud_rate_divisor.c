...
pl2303_encode_baud_rate_divisor(unsigned char buf[4], speed_t baud) {
  unsigned counterpl2303_encode_baud_rate_divisor0 = 0;
  ...
  exponent = 0;
  while (mantissa >= 512) {
    counterpl2303_encode_baud_rate_divisor0++;
    if (exponent < 7) {
