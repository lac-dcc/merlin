...
dither_int_to_float_rectangular_c(float *dst, int *src, int len) {
  unsigned counterdither_int_to_float_rectangular_c0 = 0;

  int templen = len;

  int i;
  for (i = 0; i < len; i++) {
    counterdither_int_to_float_rectangular_c0++;
  ...
  printf("at line 62 :");
  printf(" len\n");
  printf("%d %d\n", templen, counterdither_int_to_float_rectangular_c0);
}
