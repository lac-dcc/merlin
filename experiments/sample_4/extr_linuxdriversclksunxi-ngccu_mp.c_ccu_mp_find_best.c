...
ccu_mp_find_best(unsigned long parent, unsigned long rate, unsigned int max_m,
                 unsigned int max_p, unsigned int *m, unsigned int *p) {
  unsigned counterccu_mp_find_best0 = 0;
  unsigned counterccu_mp_find_best1 = 0;

  unsigned int tempmax_p = max_p;
  unsigned int tempmax_m = max_m;
  ...
  for (_p = 1; _p <= max_p; _p <<= 1) {
    counterccu_mp_find_best0++;
    for (_m = 1; _m <= max_m; _m++) {
      counterccu_mp_find_best1++;
  ...
  *p = best_p;
  ...
  printf("at line 66 :");
  printf(" max_m max_p\n");
  printf("%u %d\n", tempmax_p, counterccu_mp_find_best0);
  printf("%u %u %d\n", tempmax_m, tempmax_p, counterccu_mp_find_best1);
}
