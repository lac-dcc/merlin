...
__attribute__((used)) static void find_rms(float *src, int nb_samples,
                                           float *rms, float factor) {
  unsigned counterfind_rms0 = 0;

  int tempnb_samples = nb_samples;
  ...
  printf("at line 62 :");
  printf(" nb_samples\n");
  printf("%d %d\n", tempnb_samples, counterfind_rms0);
}
