...
__attribute__((used)) static void setclkMHz(struct imstt_par *par, __u32 MHz) {
  unsigned countersetclkMHz0 = 0;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    struct imstt_par *par =
        (struct imstt_par *)malloc(_len_par0 * sizeof(struct imstt_par));
