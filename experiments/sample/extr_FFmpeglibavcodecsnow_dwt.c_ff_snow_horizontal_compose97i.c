...
void ff_snow_horizontal_compose97i(IDWTELEM *b, IDWTELEM *temp, int width) {
  unsigned counterff_snow_horizontal_compose97i1 = 0;
  unsigned counterff_snow_horizontal_compose97i0 = 0;
  ...
  for (x = 1; x < (width >> 1); x++) {
    counterff_snow_horizontal_compose97i0++;
  ...
  for (x = 2; x < width - 1; x += 2) {
    counterff_snow_horizontal_compose97i1++;
  ...
  printf("at line 63 :");
  printf(" width\n");
  printf("%d %d\n", tempwidth, counterff_snow_horizontal_compose97i1);
  printf("%d %d\n", tempwidth, counterff_snow_horizontal_compose97i0);
}
