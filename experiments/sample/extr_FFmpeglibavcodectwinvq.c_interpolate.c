...
__attribute__((used)) static void interpolate(float *out, float v1, float v2,
                                              int size) {
  unsigned counterinterpolate0 = 0;
