...
__attribute__((used)) static void extract_mask_pos(u32 label, u8 *mask,
                                                   u8 *pos) {
  unsigned counterextract_mask_pos0 = 0;
  ...
  printf("at line 64 :");
  printf(" mask\n");
  printf("%d %d\n", *tempmask, counterextract_mask_pos0);
}
