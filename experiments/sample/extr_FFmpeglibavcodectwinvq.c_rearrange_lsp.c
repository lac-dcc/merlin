...
__attribute__((used)) static void rearrange_lsp(int order, float *lsp,
                                                float min_dist) {
  unsigned counterrearrange_lsp0 = 0;
  ...
  printf("at line 60 :");
  printf(" order\n");
  printf("%d %d\n", temporder, counterrearrange_lsp0);
}
