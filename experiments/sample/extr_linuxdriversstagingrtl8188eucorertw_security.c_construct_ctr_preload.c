...
__attribute__((used)) static void construct_ctr_preload(u8 *ctr_preload,
                                                        ...
                                                        u8 *pn_vector, int c) {
  unsigned counterconstruct_ctr_preload1 = 0;
  unsigned counterconstruct_ctr_preload2 = 0;
  unsigned counterconstruct_ctr_preload0 = 0;

  int i;

  for (i = 0; i < 16; i++) {
    counterconstruct_ctr_preload0++;
    ctr_preload[i] = 0x00;
  }
  i = 0;
  ...
  for (i = 2; i < 8; i++) {
    counterconstruct_ctr_preload1++;
    ctr_preload[i] = mpdu[i + 8]; /* ctr_preload[2:7] = A2[0:5] = mpdu[10:15] */
  }
  for (i = 8; i < 14; i++) {
    counterconstruct_ctr_preload2++;
