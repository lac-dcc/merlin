...
grub_sun_is_valid(struct grub_sun_pc_block *label, int lenlabel) {
  ...
  printf("at line 66 :");
  printf(" label\n");
  printf("%d %d\n", lenlabel, countergrub_sun_is_valid0);
  return !sum;
}
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    int _len_label0 = 1;
    struct grub_sun_pc_block *label = (struct grub_sun_pc_block *)malloc(
        _len_label0 * sizeof(struct grub_sun_pc_block));
